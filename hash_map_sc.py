...
# Assignment: 6
# Due Date: 3/11/2022
# Description: implement HashMap using (Separate) Chaining.
...
class HashMap:
    ...
    def clear(self) -> None:
        """
        Clears the contents of the hash map and does not change the underlying hash
        table capacity.
        """
    ...
    def put(self, key: str, value: object) -> None:
        ...
        the hash map, its associated value must be replaced with the new value. Otherwise,
    ...
    def table_load(self) -> float:
        ...
        total = 0
        for index in range(0, self.buckets.length()):
            total += self.buckets[index].length()
